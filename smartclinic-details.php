    ...
    <div class="row gy-4">
        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide">
              <img src="assets/img/portfolio/mysmartclinic.png" alt="">
            </div>
            <div class="swiper-slide">
              <img src="assets/img/portfolio/dashboard.png" alt="">
            </div>
            <div class="swiper-slide">
      ...
      <div class="col-lg-4">
        <div class="portfolio-info">
          ...
          <ul>
            <li><strong>Category</strong>: Laravel Website</li>
            <li><strong>Client</strong>: Final Year Project</li>
          </ul>
        </div>

        <div class="portfolio-description">
          <h2>My Smart Clinic</h2>
          <p>
            Laravel-based system for appointments and medical records.
          </p>
        </div>
      </div>
